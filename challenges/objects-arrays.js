...
*/
const displayNames = [];
zooAnimals.forEach(x => displayNames.push(`Name: ${x.animal_name}, Scientific Name: ${x.scientific_name}`));
...
zooAnimals.filter(function(x){
  if(x.population < 5){
   return lowPopulationAnimals.push(x.animal_name);
  }
})
...
*/
const populationTotal = zooAnimals.reduce(function(accumulator, x){
